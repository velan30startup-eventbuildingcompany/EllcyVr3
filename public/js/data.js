...
const STATIC_SERVICES_DATA = {
  ...
  'light-decoration': [
    { id:50, title:'Light Set Up In Party Hall',
      ...
      image:'../uploads/services/lighting.png', event_types:['wedding'] },
  ...
  'stage-decoration': [
    { id:1, title:'Party Hall Decoration',
      ...
      image:'../uploads/services/stage.png', event_types:['wedding'], descPage:true },
  ...
  'food': [
    { id:70, title:'Dinner Catering',
      ...
      base_price:450, image:'../uploads/services/catering.png', event_types:['wedding'] },
    { id:71, title:'Breakfast Catering',
      ...
      base_price:250, image:'../uploads/services/catering.png', event_types:['wedding'] },
    { id:72, title:'Lunch Catering',
      ...
      base_price:350, image:'../uploads/services/catering.png', event_types:['wedding'] },
  ],
  ...
  'dj': [
    { id:15, title:'DJ Starter Package',
      ...
      base_price:9999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:16, title:'DJ Silver Package',
      ...
      base_price:14999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:17, title:'DJ Gold Package',
      ...
      base_price:17999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:18, title:'DJ Platinum Package',
      ...
      base_price:24999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:19, title:'DJ Diamond Package',
      ...
      base_price:34999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:20, title:'DJ Ultra Package',
      ...
      base_price:47999, image:'../uploads/services/dj.png', event_types:['wedding'],
    ...
    { id:21, title:'DJ Grand Celebration Package',
      ...
      base_price:59999, image:'../uploads/services/dj.png', event_types:['wedding'],
  ...
  'chenda-melam': [
    { id:60, title:'Chenda Melam – Standard',
      ...
      base_price:12000, image:'../uploads/services/chenda-melam.png', event_types:['wedding'] },
    { id:61, title:'Chenda Melam – Grand Procession',
      ...
      base_price:22000, image:'../uploads/services/chenda-melam.png', event_types:['wedding'] },
  ],
  ...
  'nadhaswaram-thavil': [
    { id:80, title:'Nadhaswaram & Thavil – Classic',
      ...
      base_price:8000, image:'../uploads/services/nadhaswaram.png', event_types:['wedding'] },
    { id:81, title:'Nadhaswaram & Thavil – Grand',
      ...
      base_price:15000, image:'../uploads/services/nadhaswaram.png', event_types:['wedding'] },
  ],
  ...
  'band-set': [
    { id:82, title:'Band Set – 6 Members',
      ...
      base_price:11994, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:83, title:'Band Set – 8 Members',
      ...
      base_price:15992, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:84, title:'Band Set – 10 Members',
      ...
      base_price:19990, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:85, title:'Band Set – 12 Members',
      ...
      base_price:23988, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:86, title:'Band Set – 15 Members',
      ...
      base_price:29985, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:87, title:'Band Set – 18 Members',
      ...
      base_price:35982, image:'../uploads/services/bandset.png', event_types:['wedding'] },
    { id:88, title:'Band Set – 20 Members',
      ...
      base_price:39980, image:'../uploads/services/bandset.png', event_types:['wedding'] },
  ],
  ...
  'melam-set': [
    { id:90, title:'Melam Set – 4 Members',
      ...
      base_price:7994, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:91, title:'Melam Set – 6 Members',
      ...
      base_price:11994, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:92, title:'Melam Set – 8 Members',
      ...
      base_price:15992, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:93, title:'Melam Set – 10 Members',
      ...
      base_price:19990, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:94, title:'Melam Set – 12 Members',
      ...
      base_price:23988, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:95, title:'Melam Set – 15 Members',
      ...
      base_price:29985, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:96, title:'Melam Set – 18 Members',
      ...
      base_price:35982, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
    { id:97, title:'Melam Set – 20 Members',
      ...
      base_price:39980, image:'../uploads/services/musical_band.png', event_types:['wedding'] },
  ],
  ...
  'bouncers': [
    { id:40, title:'Event Security & Bouncers',
      ...
      base_price:1400, image:'../uploads/services/bouncer.png', event_types:['wedding'] },
  ],
  ...
  'entertainment-activities': [
    { id:90, title:'360 Degree Camera',
      ...
      base_price:8000, image:'../uploads/services/photobooth.png', event_types:['wedding'] },
    { id:91, title:'Photo Booth',
      ...
      base_price:6000, image:'../uploads/services/photobooth.png', event_types:['wedding'] },
    { id:92, title:'Human Doll (Mascots)',
      ...
      base_price:2499, image:'../uploads/services/fun.png', event_types:['wedding'] },
  ],
  ...
  'snacks-stalls': [
    { id:41, title:'Cotton Candy',
      ...
      base_price:3000, image:'../uploads/services/snacks.png', event_types:['wedding'] },
    { id:42, title:'Pop Corn',
      ...
      base_price:2500, image:'../uploads/services/snacks.png', event_types:['wedding'] },
    { id:43, title:'Chocolate Foundation',
      ...
      base_price:5000, image:'../uploads/services/snacks.png', event_types:['wedding'] },
    { id:44, title:'Fruit Salad',
      ...
      base_price:2000, image:'../uploads/services/snacks.png', event_types:['wedding'] },
    { id:45, title:'Ice Cream',
      ...
      base_price:3500, image:'../uploads/services/snacks.png', event_types:['wedding'] },
    { id:46, title:'Mojito & Tea',
      ...
      base_price:4000, image:'../uploads/services/snacks.png', event_types:['wedding'] },
  ],
  ...
  'enter-show-down': [
    { id:95, title:'Pyro Show',
      ...
      base_price:299, image:'../uploads/services/stage.png', event_types:['wedding'] },
    { id:96, title:'Entry Pot Fag',
      ...
      base_price:459, image:'../uploads/services/stage.png', event_types:['wedding'] },
    ...
    { id:99, title:'Balloon Blast',
      ...
      base_price:599, image:'../uploads/services/stage.png', event_types:['wedding'] },
    ...
    { id:101, title:'Gun Paper Blast',
      ...
      base_price:499, image:'../uploads/services/stage.png', event_types:['wedding'] },
  ],
  ...
  'catering-boys': [
    { id:200, title:'Welcome Girls – Breakfast',
      ...
      base_price:1500, image:'../uploads/services/welcomegirls.png', event_types:['wedding'] },
    ...
    { id:203, title:'Catering Boys – Breakfast',
      ...
      base_price:750, image:'../uploads/services/cateringboys.png', event_types:['wedding'] },
  ...
  'dancers': [
    { id:36, title:'Only Male Team',
      ...
      base_price:11196, image:'../uploads/services/dancers.png', event_types:['wedding'] },
    { id:37, title:'Only Female Team',
      ...
      base_price:15196, image:'../uploads/services/dancers.png', event_types:['wedding'] },
    { id:38, title:'Co-ED Man & Women Team',
      ...
      base_price:12998, image:'../uploads/services/dancers.png', event_types:['wedding'] },
  ],
  ...
  'invitation': [
    { id:102, title:'Digital Wedding Invitation',
      ...
      base_price:2000, image:'../uploads/services/stage.png', event_types:['wedding'] },
  ],
  ...
  'real-flowers': [
    ...
    { id:103, title:'Reception — Real Flowers',
      ...
      base_price:5000, image:'../uploads/services/stage.png', event_types:['wedding'],
    ...
    { id:104, title:'Reception — Artificial Flowers',
      ...
      base_price:6000, image:'../uploads/services/stage.png', event_types:['wedding'],
  ...
  'fake-jewellery': [
    { id:104, title:'Gold Style Jewellery',
      ...
      base_price:3000, image:'../uploads/services/stage.png', event_types:['wedding'] },
    { id:105, title:'Silver Style Jewellery',
      ...
      base_price:2500, image:'../uploads/services/stage.png', event_types:['wedding'] },
    { id:106, title:'Kundan Style Jewellery',
      ...
      base_price:3500, image:'../uploads/services/stage.png', event_types:['wedding'] },
  ],
  ...
  'car-entry': [
    ...
    { id:108, title:'Luxury Cars Entry',
      ...
      base_price:15000, image:'../uploads/services/stage.png', event_types:['wedding'] },
  ],
  ...
  'aarthi-plate': [
    { id:109, title:'Traditional Aarthi Plate',
      ...
      base_price:1500, image:'../uploads/services/stage.png', event_types:['wedding'] },
  ],
  ...
  'photography': [
    { id:701, title:'Photography — Photo Package',
      ...
      base_price:25000, image:'../uploads/services/photo.png', event_types:['wedding'], descPage:true },
    { id:702, title:'Photography — Photo + Video',
      ...
      base_price:30000, image:'../uploads/services/photo.png', event_types:['wedding'], descPage:true },
  ],
  ...
  'bridal-groom-styling': [
    { id:8,  title:'Bridal Makeup & Styling',
      ...
      base_price:12000, image:'../uploads/services/bridal.png', event_types:['wedding'] },
    { id:9,  title:'Mehanti Bridal',
      ...
      base_price:8000, image:'../uploads/services/mehandi.png', event_types:['wedding'] },
  ],
...
const STATIC_PHOTOGRAPHY_PACKAGE = {
  ...
  image: '../uploads/services/photo.png',
};
...
const DECORATION_SUBTYPES = [
  { name:'Light Decoration', slug:'light-decoration', img:'../uploads/services/lighting.png',
    desc:'Indoor & outdoor professional lighting setups for your event venue.' },
  { name:'Stage Decoration', slug:'stage-decoration', img:'../uploads/services/stage.png',
...
const MUSICAL_BAND_SUBTYPES = [
  { name:'Chenda Melam',        slug:'chenda-melam',        img:'../uploads/services/music-chenda-melam.jpg',
    desc:'Traditional Kerala Chenda Melam percussion ensemble for processions and celebrations.' },
  { name:'Nadhaswaram & Thavil',slug:'nadhaswaram-thavil',  img:'../uploads/services/music-nadhaswaram-thavil.jpg',
    desc:'Classical Nadhaswaram and Thavil duo for wedding rituals and auspicious ceremonies.' },
  { name:'Band Set',            slug:'band-set',            img:'../uploads/services/music-band-set.jpg',
    desc:'Professional brass band for baraat, processions and grand entry ceremonies.' },
  { name:'Melam Set',           slug:'melam-set',           img:'../uploads/services/music-melam-set.jpg',
    desc:'Traditional melam set for poojas, home events and large temple celebrations.' },
];

/* ── Home circles ───────────────────────────────────────────── */
const HOME_CATEGORIES = [
  { id:'dj',                    name:'DJ',                              image:'uploads/services/dj.jpg',           hidden:false },
  { id:'bridal-groom-styling',  name:'Bridal & Groom Make Up',         image:'uploads/services/bridal.png',       hidden:false },
  { id:'decoration',            name:'Decoration',                  image:'uploads/services/decoration-stage-indoor.jpg', hidden:false, slug:'decoration' },
  { id:'catering-boys',         name:'Catering Boys / Welcome Girls',   image:'uploads/services/catering-boys.jpg', hidden:false },
  { id:'entertainment-activities', name:'Entertainment Activities',     image:'uploads/services/entertainment-mascots.jpg', hidden:false },
  { id:'snacks-stalls',         name:"Snacks & Stalls",                 image:'uploads/services/snacks-popcorn.jpg', hidden:false },
  { id:'photography',           name:'Photography',                     image:'uploads/services/photography.jpg', hidden:true },
  { id:'music-performers',      name:'Music Performers',                image:'uploads/services/music-band-set.jpg', hidden:true, slug:'musical-band' },
  { id:'bouncers',              name:"Bouncer's",                       image:'uploads/services/bouncers.jpg', hidden:true },
  { id:'dancers',               name:'Dancers',                         image:'uploads/services/dancers-coed.jpg', hidden:true },
  { id:'food',                  name:'Food',                            image:'uploads/services/catering.png',         hidden:true },
];

/* ── Home event tiles ───────────────────────────────────────── */
const HOME_EVENTS = [
  { id:'wedding',  title:'Wedding Events',  desc:'Elegant wedding arrangements and full event management.',  image:'uploads/category/wedding/service1.png',  comingSoon:false },
  ...
  { id:'college',  title:'College Events',  desc:'Full-stage setup and sound systems for college fests.',   image:'uploads/category/college/service3.png',   comingSoon:true  },
  { id:'temple',   title:'Temple Events',   desc:'Traditional temple decorations and sound systems.',       image:'uploads/category/temple/service4.png',    comingSoon:true  },
];

/* ── Category page mappings ─────────────────────────────────── */
const CATEGORY_MAPPINGS = {
  wedding: [
    { name:'Decoration',                slug:'decoration',               img:'../uploads/services/decoration-stage-indoor.jpg' },
    { name:'Photography',                   slug:'photography',              img:'../uploads/services/photography.jpg' },
    { name:'Food',                          slug:'food',                     img:'../uploads/services/catering.png' },
    { name:'DJ',                            slug:'dj',                       img:'../uploads/services/dj.jpg' },
    { name:'Music Performers',              slug:'musical-band',             img:'../uploads/services/music-band-set.jpg' },
    { name:"Bouncer's",                     slug:'bouncers',                 img:'../uploads/services/bouncers.jpg' },
    { name:'Entertainment Activities',      slug:'entertainment-activities', img:'../uploads/services/entertainment-mascots.jpg' },
    { name:"Snacks & Stalls",               slug:'snacks-stalls',            img:'../uploads/services/snacks-popcorn.jpg' },
    { name:'Enter Show Down',               slug:'enter-show-down',          img:'../uploads/services/entershow-pyro-show.jpg' },
    { name:'Catering Boys / Welcome Girls', slug:'catering-boys',           img:'../uploads/services/catering-boys.jpg' },
    { name:'Dancers',                       slug:'dancers',                  img:'../uploads/services/dancers-coed.jpg' },
    { name:'Real Flowers',                  slug:'real-flowers',             img:'../uploads/services/flowers-decoration-1.jpg' },
    { name:'Fake Jewellery',                slug:'fake-jewellery',           img:'../uploads/services/jewellery-gold.jpg' },
  ...
  food: [
    ...
    { name:'Lunch',     slug:'food-lunch',     img:'../uploads/services/food-veg.jpg' },
    { name:'Dinner',    slug:'food-dinner',    img:'../uploads/services/food-buffet-veg.jpg' },
  ],
  birthday: [],
  college:  [],
  temple:   [],
...
(function () {
  ...
  function toLegacyItem(row) {
    ...
    return Object.assign({
      ...
      image: row.image || 'uploads/services/stage.png',
      event_types: ['wedding'],
      slug: row.slug
    }, extra);
  }
  ...
  function toLegacyPackage(row, pkg, index) {
    ...
    return Object.assign({}, fallback, {
      ...
      image: pkg.image || row.image || fallback.image || 'uploads/services/stage.png',
